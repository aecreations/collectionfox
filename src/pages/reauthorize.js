...
async function reauthorize(aBackend)
{
  ...
  try {
    ...
    log("CollectionFox::reauthorize.js: " + e);
  ...
  log("CollectionFox::reauthorize.js: Retrying reading list sync...");
...
browser.runtime.onMessage.addListener(aMessage => {
  log(`CollectionFox::reauthorize.js: Received extension message "${aMessage.id}"`);
